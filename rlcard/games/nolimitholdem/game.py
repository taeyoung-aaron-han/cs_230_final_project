...
class NolimitholdemGame(Game):
    ...
    def get_legal_actions(self):
        ...
        """
        return self.round.get_nolimit_legal_actions(players=self.players, action_history = self.action_history, round_counter = self.round_counter)
    ...
    def get_payoffs(self):
        ...
        """
        player_statuses = [p.status for p in self.players]
        if PlayerStatus.ALLIN in player_statuses:
